<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="User_Hn_Eng.aspx.cs" Inherits="Face_scan.User_Hn_Eng" %>
                ...
                success: function (data) {
                    ...
                    if (data != null)
                        if (data.d.StatusCode != -1) {
                            window.location.href = 'User_detail_eng.aspx';
                        } else {
                            close_popup();
                            try {
                                $('#popup_message').modal({
                ...
                <div class="modal-dialog" role="document">
                     <div class="modal-content" style=" width: 800px;height:500px;">
                        <div class="modal-body" style="position: relative; overflow: hidden; padding:0px">
                            ...
                            <img src="img/balloon_modal popup_size big_v2.png" alt=""  style="
                                    height: 500px;
                                    width: 800px;
                                    padding-left: 0px;
                                "/>
